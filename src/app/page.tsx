...
export default async function PageDashboard({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Indicateurs du mois affiché — synthèse de trésorerie réalisée */}
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        <Indicateur titre="Coût total" valeur={formatEuro(coutTotal)} />
        <Indicateur titre="Marge brute" valeur={formatEuro(margeBrute)} />
